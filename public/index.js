...
//     const htmlWelcome = username.map((elem) => {
//         return (`<div class="alert alert-success my-5" role="alert">
//                     Bienvenido usuario ${elem} 
//                 </div>`)
//     }).join('')

//     document.getElementById('mostrarUserName').innerHTML = htmlWelcome
// }